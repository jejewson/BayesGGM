...
```{r Final_Inference_Comparison_p10_diag, include = TRUE, echo = TRUE, eval = FALSE, cache = FALSE}
...
```{r Final6_Inference_Comparison_p10_diag, include = TRUE, echo = TRUE, eval = FALSE, cache = FALSE, dev = 'tikz', fig.width=10, fig.height = 8}
#, fig.height = 6}
